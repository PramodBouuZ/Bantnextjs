        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-bold">
              <li><Link href="/products" className="hover:text-amber-400 transition-colors">Marketplace</Link></li>
              <li><Link href="/become-vendor" className="hover:text-amber-400 transition-colors">Vendor Registration</Link></li>
              <li><Link href="/post-requirement" className="hover:text-amber-400 transition-colors">Post Enquiry</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm font-bold">
               <li><Link href="/blog" className="hover:text-amber-400 transition-colors">Industry Insights</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-6 text-sm font-medium">
               ...
               <li className="flex items-center font-black text-green-400"><Phone className="mr-3" size={18}/> +91 99000 88000</li>
            </ul>
          </div>
        </div>
